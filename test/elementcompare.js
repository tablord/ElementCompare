...
describe('ElementCompare',  function () {
    ...
    it('check text difference', function(){
        var comp = new ElementCompare("<div>Hello</div>","<div>Bonjour</div>");
        comp.compare().should.be.false();
    ...
    it('check text difference in child', function(){
        var comp = new ElementCompare("<div><h1>Hello</h1>Good morning</div>","<div><h1>Bonjour</h1>Good morning</div>");
        comp.compare().should.be.false();
